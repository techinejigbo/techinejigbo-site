          ...
          <div className="md:col-span-7 space-y-5">
            <div className="space-y-2">
              ...
              <p className="text-slate-500 text-sm leading-relaxed">
                {isPassed 
                  ? `Incredible job, ${student.fullName}! You have successfully demonstrated your proficiency in ${
                      student.course === 'canva' ? 'Basic Canva' : 'Basic HTML'
                    } with a passing score of ${percentage}%. Your certification is ready below.`
          ...
          <div className="bg-white border border-slate-200 p-1 sm:p-4 rounded-lg overflow-x-auto shadow-sm">
            ...
            >
              ...
              <div className="space-y-4 max-w-xl mx-auto my-8">
                ...
                {/* Course Name */}
                <div className="text-xl sm:text-2xl font-black text-zinc-900 tracking-tight font-display py-1.5 uppercase">
                  {student.course === 'canva' ? 'Basic Canva Graphic Design' : 'Basic HTML Web Development'}
                </div>
